...
const AddFriends = (props) =>{
    ...
    return (
        <div style={{width :'100%',margin:'70px'}} className="container flex flex-col mx-auto w-full items-center justify-center bg-white dark:bg-gray-800 rounded-lg shadow">
